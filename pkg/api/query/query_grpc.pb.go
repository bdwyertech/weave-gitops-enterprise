...
func (c *queryClient) DoQuery(ctx context.Context, in *DoQueryRequest, opts ...grpc.CallOption) (*DoQueryResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_DoQuery_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ListFacets(ctx context.Context, in *ListFacetsRequest, opts ...grpc.CallOption) (*ListFacetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ListFacets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) DebugGetAccessRules(ctx context.Context, in *DebugGetAccessRulesRequest, opts ...grpc.CallOption) (*DebugGetAccessRulesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_DebugGetAccessRules_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ListEnabledComponents(ctx context.Context, in *ListEnabledComponentsRequest, opts ...grpc.CallOption) (*ListEnabledComponentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ListEnabledComponents_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
